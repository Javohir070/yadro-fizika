...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Yangiliklar'])

    <div class="mb-9">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            <h2 class="mb-0 fw-semibold">Yangiliklar</h2>
            <a href="{{ route('admin.news.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex align-items-center gap-2">
                                        <a href="{{ route('admin.news.show', $item) }}" class="btn btn-outline-success"
                                        ...
                                        <form action="{{ route('admin.news.destroy', $item) }}" method="POST" class="d-inline">
                                            ...
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Yangilik o\'chirilsinmi?')">
