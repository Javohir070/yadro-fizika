...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Galereya'])

    <div class="mb-9">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            <h2 class="mb-0 fw-semibold">Galereya</h2>
            <a href="{{ route('admin.galleries.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
                    ...
                    <tbody>
                        @forelse ($galleries as $gallery)
                            <tr>
                                ...
                                <td>
                                    <button type="button"
                                        class="btn btn-sm rounded-pill {{ $gallery->is_active ? 'btn-success' : 'btn-secondary' }}"
                                        disabled>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex align-items-center gap-2">
                                        <a href="{{ route('admin.galleries.show', $gallery) }}" class="btn btn-outline-success"
