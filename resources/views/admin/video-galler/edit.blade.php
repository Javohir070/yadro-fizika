...
@section('content')
    <style>
        #video-galler-lang-tabs-edit .video-galler-lang-tab-btn {
            border-bottom: 2px solid transparent !important;
            border-radius: 0;
        }

        #video-galler-lang-tabs-edit .video-galler-lang-tab-btn.active {
            border-bottom-color: #f4a259 !important;
        }
    </style>

    @include('admin.components.navbar_top', ['maniUrl' => 'Video tahrirlash'])

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Video tahrirlash</h3>
        <a href="{{ route('admin.video-gallers.index') }}" class="btn btn-secondary">Orqaga</a>
    </div>

    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form action="{{ route('admin.video-gallers.update', $videoGaller) }}" method="POST">
                @csrf
                @method('PUT')

                <ul class="nav nav-underline mb-3" id="video-galler-lang-tabs-edit">
                ...
                <div class="row g-3 video-galler-lang-panel" data-lang-panel="uz">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="title_uz" value="{{ old('title_uz', $videoGaller->title_uz) }}"
                ...
                <div class="row g-3 video-galler-lang-panel d-none" data-lang-panel="ru">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="title_ru" value="{{ old('title_ru', $videoGaller->title_ru) }}"
                ...
                <div class="row g-3 video-galler-lang-panel d-none" data-lang-panel="en">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="title_en" value="{{ old('title_en', $videoGaller->title_en) }}"
                ...
                <div class="row g-3 mt-1">
                    <div class="col-md-12">
                        ...
                        <input type="url" name="url" value="{{ old('url', $videoGaller->url) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="0" name="order" value="{{ old('order', $videoGaller->order) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="is_active" class="form-select @error('is_active') is-invalid @enderror">
                            <option value="1" @selected(old('is_active', $videoGaller->is_active ? '1' : '0') == '1')>Aktiv</option>
                            <option value="0" @selected(old('is_active', $videoGaller->is_active ? '1' : '0') == '0')>Nofaol</option>
                        </select>
                ...
                <div class="mt-4 d-flex gap-2 justify-content-end">
                    ...
                    <a href="{{ route('admin.video-gallers.show', $videoGaller) }}" class="btn btn-outline-info">Ko'rish</a>
