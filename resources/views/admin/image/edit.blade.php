...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Rasm tahrirlash</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.images.update', $image) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="is_active" class="form-select @error('is_active') is-invalid @enderror">
                            <option value="1" {{ old('is_active', $image->is_active) == 1 ? 'selected' : '' }}>Aktiv</option>
                            <option value="0" {{ old('is_active', $image->is_active) == 0 ? 'selected' : '' }}>Nofaol</option>
                        </select>
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.images.show', $image) }}" class="btn btn-outline-info">Ko'rish</a>
