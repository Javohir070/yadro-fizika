...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Foydalanuvchi yaratish'])

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Foydalanuvchi yaratish</h3>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        @include('admin.components.role-checkboxes', ['roles' => $roles])
                    </div>
                </div>
