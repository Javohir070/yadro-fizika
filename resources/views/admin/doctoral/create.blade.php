...
@section('content')
    <style>
        #doctoral-lang-tabs-create .doctoral-lang-tab-btn {
            border-bottom: 2px solid transparent !important;
            border-radius: 0;
        }

        #doctoral-lang-tabs-create .doctoral-lang-tab-btn.active {
            border-bottom-color: #f4a259 !important;
        }
    </style>

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Doktorantura — qo'shish</h3>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('admin.doctorals.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <ul class="nav nav-underline mb-3" id="doctoral-lang-tabs-create">
                ...
                <div class="row g-3 doctoral-lang-panel" data-lang-panel="uz">
                    <div class="col-md-12">
                ...
                <div class="row g-3 doctoral-lang-panel d-none" data-lang-panel="ru">
                    <div class="col-md-12">
                ...
                <div class="row g-3 doctoral-lang-panel d-none" data-lang-panel="en">
                    <div class="col-md-12">
                ...
                <div class="row g-3 mt-1">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" value="{{ old('code') }}"
                            class="form-control @error('code') is-invalid @enderror" placeholder="Masalan: 05.01.11">
    ...
    <script>
        (function() {
            const tabs = document.querySelectorAll('#doctoral-lang-tabs-create [data-lang]');
            const panels = document.querySelectorAll('.doctoral-lang-panel');
