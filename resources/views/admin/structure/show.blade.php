...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0 fw-semibold">Tuzilma tafsiloti</h3>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.structures.edit', $structure) }}" class="btn btn-warning">Tahrirlash</a>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <div class="p-3 rounded border">
                        ...
                        <button type="button"
                            class="btn btn-sm rounded-pill {{ $structure->is_active ? 'btn-success' : 'btn-secondary' }}" disabled>
