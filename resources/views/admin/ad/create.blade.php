...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Elon yaratish'])

    <style>
        #ad-lang-tabs-create .ad-lang-tab-btn {
            border-bottom: 2px solid transparent !important;
            border-radius: 0;
        }

        #ad-lang-tabs-create .ad-lang-tab-btn.active {
            border-bottom-color: #f4a259 !important;
        }
    </style>

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Elon bloki yaratish</h3>
                ...
                <div class="row g-3 ad-lang-panel" data-lang-panel="uz">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="title_uz" class="form-control @error('title_uz') is-invalid @enderror"
                            value="{{ old('title_uz') }}" placeholder="Sarlavha...">
                ...
                <div class="row g-3 ad-lang-panel d-none" data-lang-panel="ru">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="title_ru" class="form-control @error('title_ru') is-invalid @enderror"
                            value="{{ old('title_ru') }}" placeholder="Заголовок...">
    ...
    <x-admin.summernote-lang-tabs-script tabs-selector="#ad-lang-tabs-create [data-lang]"
