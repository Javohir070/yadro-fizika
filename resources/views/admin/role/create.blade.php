...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Rol yaratish'])

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Rol yaratish</h3>
            ...
            <form action="{{ route('admin.roles.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        @include('admin.components.permission-checkboxes', ['permissions' => $permissions])
                    </div>
                </div>
