...
@section('content')
    @include('admin.components.navbar_top', ['maniUrl' => 'Institut nizomi'])

    <div class="mb-9">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            <h2 class="mb-0 fw-semibold">Institut nizomi</h2>
            <a href="{{ route('admin.charters.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
                    ...
                    <tbody>
                        @forelse ($charters as $charter)
                            <tr>
                                ...
                                <td>{!! \Illuminate\Support\Str::limit(strip_tags($charter->details_uz), 120) !!}</td>
                                <td>
                                    <button type="button"
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex align-items-center gap-2">
                                        ...
                                        <a href="{{ route('admin.charters.edit', $charter) }}"
                                            class="btn btn-outline-primary" style="display:inline-block;padding:8px;">
                                            <i data-feather="edit" class="w-4 h-4"></i>
                                        </a>
                                        <form action="{{ route('admin.charters.destroy', $charter) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Institut nizomi o\'chirilsinmi?')">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <a href="{{ route('admin.charters.create') }}" class="btn btn-primary btn-sm">Birinchi
                                        yozuvni qo'shish</a>
                                </td>
                            </tr>
                        @endforelse
