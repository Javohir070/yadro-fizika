...
@section('content')
    <style>
        #leadership-lang-tabs-create .leadership-lang-tab-btn {
            border-bottom: 2px solid transparent !important;
            border-radius: 0;
        }

        #leadership-lang-tabs-create .leadership-lang-tab-btn.active {
            border-bottom-color: #f4a259 !important;
        }
    </style>

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Rahbariyat yaratish</h3>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('admin.leaderships.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <ul class="nav nav-underline mb-3" id="leadership-lang-tabs-create">
                ...
                <div class="row g-3 leadership-lang-panel" data-lang-panel="uz">
                    <div class="col-md-6">
                ...
                <div class="row g-3 leadership-lang-panel d-none" data-lang-panel="ru">
                    <div class="col-md-6">
                ...
                <div class="row g-3 leadership-lang-panel d-none" data-lang-panel="en">
                    <div class="col-md-6">
    ...
    <script>
        (function() {
            const tabs = document.querySelectorAll('#leadership-lang-tabs-create [data-lang]');
            const panels = document.querySelectorAll('.leadership-lang-panel');
