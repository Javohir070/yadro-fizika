...
@section('content')
    ...
    @include('admin.components.navbar_top', ['maniUrl' => 'Mehnat faoliyati qo\'shish'])

    <div class="mb-9">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            <div>
                <h3 class="mb-1 fw-semibold">Mehnat faoliyati — qo'shish</h3>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                <form action="{{ route('admin.laboratories.teams.work-activities.store', [$laboratory, $team]) }}" method="POST">
                    @csrf
                    @include('admin.laboratory.work-activities._form')
