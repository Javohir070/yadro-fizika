...
@section('content')
    <style>
        #institute-director-lang-tabs-create .institute-director-lang-tab-btn {
            border-bottom: 2px solid transparent !important;
            border-radius: 0;
        }

        #institute-director-lang-tabs-create .institute-director-lang-tab-btn.active {
            border-bottom-color: #f4a259 !important;
        }
    </style>

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        <h3 class="mb-0">Institut direktorlari — yaratish</h3>
        <a href="{{ route('admin.institute-directors.index') }}" class="btn btn-secondary">Orqaga</a>
    </div>

    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form action="{{ route('admin.institute-directors.store') }}" method="POST">
                @csrf

                <ul class="nav nav-underline mb-3" id="institute-director-lang-tabs-create">
                ...
                <div class="row g-3 institute-director-lang-panel" data-lang-panel="uz">
                    <x-admin.summernote-field name="details_uz" label="Tafsilot (UZ)" :rows="8" :height="480" />
                </div>

                <div class="row g-3 institute-director-lang-panel d-none" data-lang-panel="ru">
                    <x-admin.summernote-field name="details_ru" label="Tafsilot (RU)" :rows="6" :height="384" />
                </div>

                <div class="row g-3 institute-director-lang-panel d-none" data-lang-panel="en">
    ...
    <x-admin.summernote-lang-tabs-script tabs-selector="#institute-director-lang-tabs-create [data-lang]"
        panels-selector=".institute-director-lang-panel" />
@endsection
