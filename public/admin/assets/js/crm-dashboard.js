(function (factory) {
    ...
    const echartsRevenueTargetInit = () => {
       const {
          getColor: e,
          getData: t
       } = window.phoenix.utils, o = document.querySelector(".echart-revenue-target-conversion"), a = [200, 200, 200, 200], r = [110, 180, 150, 200];
       if (o) {
          const i = t(o, "echarts"),
          ...
          echartSetOption(n, i, (() => ({
             ...
             yAxis: {
                data: ["4-chorak", " 3-chorak", "2-chorak", "1-chorak"],
                type: "category",
                axisPointer: {
                   type: "none"
                },
